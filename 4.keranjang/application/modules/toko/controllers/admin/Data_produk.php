...
class Data_produk extends CI_Controller {
    ...
    { 
        ...
        $this->load->view('toko/fpdf1/lat1211450');
    ...
    { 
        ...
        $this->load->view('toko/template_admin/header');
        $this->load->view('toko/template_admin/sidebar');
        $this->load->view('toko/admin/data_produk',$data);
        $this->load->view('toko/template_admin/footer');
    }
    ...
    public function tambah_aksi()
    {
        ...
        redirect('toko/admin/data_produk/index');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('toko/template_admin/header');
        $this->load->view('toko/template_admin/sidebar');
        $this->load->view('toko/admin/edit_produk',$data);
        $this->load->view('toko/template_admin/footer');
    }
