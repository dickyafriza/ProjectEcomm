...
//fungsi untuk menampilkan isi halaman jual
    ...
    {   
        ...
        $this->load->view('toko/admin/jual',$data);
...
//fungsi untuk menampilkan detail jual
    public function detail($id_jual)
    {
       $data['jual'] = $this->model_jual->ambil_idjual($id_jual);
        ...
        $this->load->view('toko/template_admin/header');
        $this->load->view('toko/template_admin/sidebar');
        $this->load->view('toko/admin/detail_jual',$data);
        $this->load->view('toko/template_admin/footer');
    }
    public function Data_Jual()
    { 
      
        $this->load->view('toko/fpdf1/lat1411450');
    ...
    { 
        ...
        $this->load->view('toko/fpdf1/lat1311450',$data);
