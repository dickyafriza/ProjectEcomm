    ...
    <table class="table table-bordered">
        ...
        foreach($produk as $prd): ?>
            <tr>
                ...
                <td><?php echo anchor('toko/admin/data_produk/edit/'.$prd->id_brg,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit "></i></div>') ?></td>
                <td><?php echo anchor('toko/admin/data_produk/hapus/'.$prd->id_brg,'<div class="btn btn-danger btn-sm"><i class="fas fa-trash "></i></div>') ?></td>
            </tr>
        <?php endforeach; ?>
    </table>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form action="<?php echo base_url().'toko/admin/data_produk/tambah_aksi'; ?>"method=POST enctype="multipart/form-data">
